...
<html>
  ...
  <body>
    ...
    if(isset($_POST['save'])){
      ...
      $fname = mysqli_real_escape_string($data,$_POST['fname']);
      $lname = mysqli_real_escape_string($data,$_POST['lname']);
      $uname = mysqli_real_escape_string($data,$_POST['uname']);
      ...
      if(mysqli_num_rows($result)>0){
        echo "user name alrady exist";
      }else{
        $sql1 = "INSERT INTO user(first_name,last_name,username,p_assword,r_ole) values('{$fname}','{$lname}','{$uname}','{$pass}','{$role}') " ;
    ...
    <div class="main-block">
      ...
      <form action="<?php $_SERVER['PHP_SELF'];?>" method = "post">
        ...
        <hr>
        <div class="gender">
          <input type="radio" value="0" id="normal" name="role" checked/>
          <label for="normal" class="radio">normal user</label>
          <input type="radio" value="1" id="admin" name="role" />
        ...
        <div class="btn-block">
          ...
          <button name = "save" type="submit" href="/">Submit</button>
        </div>
      </form>
    </div>
  </body>
