...
<html>
    ...
    <body>
        ...
        ?>
    <h2 class="text-muted" style="text-align:center;">Search:<?php echo $url_id; ?></h2>
    ...
    --    use like and % doe search all data related that words check post.title only title 
    -- or post.d_escription use to search paragraph
       WHERE post.title LIKE '%{$url_id}%' OR post.d_escription LIKE '%{$url_id}%' 
